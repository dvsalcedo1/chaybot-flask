...
rules = {
    ...
    'head_06': {'function': head_06, 'parts': ['headline', 'body'], 'ruleDesc': 'Headlines shouldnt have long words'},
    'head_09': {'function': head_09, 'parts': ['headline', 'body'], 'ruleDesc': 'Headlines should have single quotes and not double quotes'},
    'head_10': {'function': head_10, 'parts': ['headline', 'body'], 'ruleDesc': 'Headlines should use en dash and not hyphen or colon when indicating source'},
    'head_11': {'function': head_11, 'parts': ['headline', 'body'], 'ruleDesc': 'Headlines should use digits and not spelled out except for zero'},
    'head_12': {'function': head_12, 'parts': ['headline', 'body'], 'ruleDesc': 'Headline word after colon should be capitalized'},
    # 'subhead_01': {'function': subhead_01, 'parts': ['headline', 'body'], 'ruleDesc': 'Subhead should not exceed 200 characters'},
    # 'subhead_06': {'function': subhead_06, 'parts': ['headline', 'body'], 'ruleDesc': 'Subhead should have single quotes and not double quotes'},
    # 'dateline_03': {'function': dateline_03, 'parts': ['headline', 'body'], 'ruleDesc': 'Metro Manila Dateline should use MANILA, PHILIPPINES'},
    # 'breaker_01': {'function': breaker_01, 'parts': ['headline', 'body'], 'ruleDesc': 'Breakers should be in H5 format'},
    # 'breaker_02': {'function': breaker_02, 'parts': ['headline', 'body'], 'ruleDesc': 'Breakers should not exceed 4 words'},
    # 'breaker_05': {'function': breaker_05, 'parts': ['headline', 'body'], 'ruleDesc': 'Beakers use single quotes, not double quotes or italics'},
    # 'url_01': {'function': url_01, 'parts': ['headline', 'body'], 'ruleDesc': 'URLs should have 11 words max'},
    # 'url_04': {'function': url_04, 'parts': ['headline', 'body'], 'ruleDesc': 'URLs should not have punctuations'},
    # 'url_06': {'function': url_06, 'parts': ['headline', 'body'], 'ruleDesc': 'URLs should not begin with a number'},
